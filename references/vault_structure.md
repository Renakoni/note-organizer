...
If no suitable structure exists, create a chapter-based vault:
...
Before finalizing vault files, run a link quality pass:
...
Use when local sources are incomplete, contradictory, unreadable, or extraction is distorted:
